      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">
            Defina os tipos de atendimento, capacidade das turmas, duração e preços avulso ou em pacote.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <CardContent className="p-4 pt-0 space-y-3">
                  <div className="border-t border-border/70 pt-2.5 flex items-start justify-between gap-3 text-xs">
                    <div className="space-y-1.5 text-muted-foreground">
                      ...
                      {svc.modality === "turma" && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span>Até {svc.maxCapacity ?? 4} alunos</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="text-right shrink-0 space-y-1">
                      <div>
                        <span className="text-[10px] text-muted-foreground block">Sessão avulsa</span>
                        <span className="text-base font-bold text-foreground">
                          R$ {formatPrice(svc.defaultPrice)}
                        </span>
                      </div>
                      {svc.packagePricePerSession !== undefined && svc.packagePricePerSession > 0 && (
                        <div>
                          <span className="text-[10px] text-muted-foreground block">No pacote / sessão</span>
                          <span className="text-xs font-semibold text-primary">
                            R$ {formatPrice(svc.packagePricePerSession)}
                          </span>
                        </div>
                      )}
                    </div>
