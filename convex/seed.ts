  ...
  handler: async (ctx) => {
    ...
    if (existingPackages.length === 0) {
      pkgPilates2xId = await ctx.db.insert("packages", {
        ...
        cardInstallments: 2,
        insurancePrice: 320,
        insurancePricePix: 290,
        insuranceCardInstallments: 2,
        groupDetails: "Turmas de até 4 Alunos",
      ...
      pkgPilates3xId = await ctx.db.insert("packages", {
        name: "Fortalecimento Muscular - 2X na Semana, 1 Hora de Aula",
        serviceId: sPilatesId,
        sessionCount: 8,
        validityDays: 30,
        price: 260,
        ...
        cardInstallments: 1,
        insurancePrice: 240,
        insurancePricePix: 220,
        insuranceCardInstallments: 1,
        groupDetails: "Grupo de até 5 Pessoas (Mensal)",
        showInPublicBooking: true,
        description: "Treino funcional e fortalecimento muscular em grupo reduzido de até 5 pessoas.",
        active: true,
      })
      ...
      pkgFisio10Id = await ctx.db.insert("packages", {
        ...
        cardInstallments: 2,
        insurancePrice: 420,
        insurancePricePix: 300,
        insuranceCardInstallments: 2,
        groupDetails: "Grupo de até 8 Pessoas",
        showInPublicBooking: true,
        description: "Tratamento de fisioterapia ortopédica e cinesioterapia em grupo de até 8 pessoas.",
        active: true,
      })
      ...
      pkgRpg5Id = await ctx.db.insert("packages", {
        ...
        cardInstallments: 1,
        insurancePrice: 70,
        insurancePricePix: 70,
        insuranceCardInstallments: 1,
        groupDetails: "Atendimento Individual (Sessão)",
        showInPublicBooking: true,
        description: "Sessão individual de reeducação postural global e alinhamento biomecânico.",
        active: true,
      })
    } else {
