...
export const createPackage = mutation({
  args: {
    ...
    price: v.number(),
    pricePix: v.optional(v.number()),
    cardInstallments: v.optional(v.number()),
    insurancePrice: v.optional(v.number()),
    insurancePricePix: v.optional(v.number()),
    insuranceCardInstallments: v.optional(v.number()),
    groupDetails: v.optional(v.string()),
    showInPublicBooking: v.optional(v.boolean()),
  ...
  handler: async (ctx, args) => {
    return await ctx.db.insert("packages", {
      ...
      price: args.price,
      pricePix: args.pricePix,
      cardInstallments: args.cardInstallments,
      insurancePrice: args.insurancePrice,
      insurancePricePix: args.insurancePricePix,
      insuranceCardInstallments: args.insuranceCardInstallments,
      groupDetails: args.groupDetails,
      showInPublicBooking: args.showInPublicBooking ?? true,
